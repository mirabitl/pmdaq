...
void MbmdccManager::parseParameters()
{
...
void MbmdccManager::resetCounter()
{
  this->writeRegister(mbmdcc::Message::Register::ACQ_CTRL, 0x1);
  this->writeRegister(mbmdcc::Message::Register::ACQ_CTRL, 0x0);
}
