...
namespace pm {
  ...
  */
  class dummywriter : public pm::evbprocessor
  {
  public:
    ...
    /**
       ...
       \param dss is the list of pm::buffer
     */
    ...
    /**
       ...
       \details It copies the vectore in a pm::buffer with detectorId 255 and eventId 0 and store it on disk
     */
